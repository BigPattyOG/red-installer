...
function Assert-NotWSL {
    ...
    if ($isWSL) {
        Write-Colour ""
        Write-Colour "  +----------------------------------------------------------+" "Yellow"
        Write-Colour "  |              Looks like you're using WSL!                |" "Yellow"
        Write-Colour "  +----------------------------------------------------------+" "Yellow"
        Write-Colour ""
        Write-Colour "  Sneaky move running a PowerShell script inside WSL..." "White"
        Write-Colour ""
        Write-Colour "  This script is built for native Windows (choco, cmd, etc.)" "White"
        Write-Colour "  and won't work properly inside WSL." "White"
        Write-Colour ""
